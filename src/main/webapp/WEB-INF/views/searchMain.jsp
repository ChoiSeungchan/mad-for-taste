...
<div class="col-md-12">
	...
	<ul class="pagination">
      <li>
        <a href="${initParam.root}searchGetArticles?currPage=${page.beginPage-1}&searchVal=${searchVal}&event=${event}">Prev</a>
      </li>
      <c:if test="${page.currentPageGroup!=1 && page.pageGroupCount!=0}">
      <li>
      	<a href="${initParam.root}searchGetArticles?currPage=1&searchVal=${searchVal}&event=${event}">1</a>
      </li>
      <li>
      	<a href="#">...</a>
      </li>
      ...
      <c:choose>
	      ...
	      <li class="active">
	        <a href="${initParam.root}searchGetArticles?currPage=${p}&searchVal=${searchVal}&event=${event}">${p}</a>
	      </li>
      	</c:when>
      	<c:otherwise>
	      <li>
      ...
      <li>
  	  ...
  	  <li>
      	<a href="${initParam.root}searchGetArticles?currPage=${page.pageCount}&searchVal=${searchVal}&event=${event}">${page.pageCount}</a>
      </li>
      </c:if>
      <li>
        <a href="${initParam.root}searchGetArticles?currPage=${page.endPage+1}&searchVal=${searchVal}&event=${event}">Next</a>
      </li>
    </ul>
	</div>
</div>
