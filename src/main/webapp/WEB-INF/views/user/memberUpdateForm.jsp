...
<form:form action="updateMember" method="post" enctype="multipart/form-data" commandName="member">
  <div class="form-group">
    ...
    <form:input type="text" readonly="true" class="form-control" path="id" name="id" id="id" value="${sessionScope.member.id}" placeholder="아이디를 입력하세요"/>
  ...
  <div class="form-group">
    ...
    <form:input type="text" class="form-control" path="tel" name="tel" id="tel" value="${sessionScope.member.tel}" placeholder="전화번호를 입력하세요"/>
